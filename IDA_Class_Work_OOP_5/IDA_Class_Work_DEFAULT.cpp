...
// Class Work 31.05.2023 -------------------------------------------	

// выносим в отдельный файл описание классов
//class Super_class
//{
//private:
//	int _id;
...
void Task_1()
{
	Super_class super_object_stack(555);
	Super_class* super_object = new Super_class(777);
	super_object->ShowId();
	super_object_stack.ShowId();
}
//Task 2
void Task_2()
{
	Bread Hleb("Chusovskoi", 35.49, 0.897, "Cherny");
	Milk Kurgan("Prostokvashino", 75.85, 1.525, 4);
	...
	Supermarket_1.AddProduct(&Hleb);
	Supermarket_1.AddProduct(&Kurgan);
	std::cout << "\nThrough Supemarket class object:\n\n";
	Supermarket_1.ShowData();
